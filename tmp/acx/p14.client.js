  ...
  apply(ctx) {
    ...
    async function refreshInner() {
      ...
      for (let i = 0; i < roots.length; i++) {
        ...
        if (r.truncated) note = root + ' \u5185\u5bb9\u8fc7\u591a\uff0c\u4ec5\u663e\u793a\u524d 200 \u9879'
      }
    ...
    console.log('[agent-canvas] client apply pkg-14: panel "' + PANEL_ID + '" registered, ws=' + String(store.get().workspace) + ' touch=' + String(detectTouch()))
  },
}
