...
const h = fs.readFileSync('/tmp/acx/v20.host.js', 'utf8')
...
check('dialog renders before the inspector', c.indexOf("form.kind === 'workspace'") < c.indexOf('} else if (inspectAgent) {'))
...
re('picker throw is visible', /errText = String\(\(e && e\.message\) \|\| e\)[\s\S]{0,500}setFormErr\('\\u7cfb\\u7edf\\u9009\\u62e9\\u5668/, c)
