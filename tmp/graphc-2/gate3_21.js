...
const checks = [
  ...
  ['bar above dock', (function(){var i=c.indexOf('.acx-bar{');var b=Number(/z-index:(\d+)/.exec(c.slice(i,i+400))[1]);var j=c.indexOf('.acx-right{');var d=Number(/z-index:(\d+)/.exec(c.slice(j,j+400))[1]);return b>d})()],
  ...
  ['dock offset below bar', /\.acx-right\{position:absolute;top:96px/.test(c)],
  ...
  ['user message fix', /role: 'user', text: blocksText\(data\.content\)/.test(c)],
    ['host 10 handlers', (h.match(/harness\.handle\(/g) || []).length === 11],
